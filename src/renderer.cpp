...
void render_page() {
    ...
    switch (page) {
        ...
        case static_cast<int>(Page::WISHLIST_APPROVAL): {
            wishlist_approval::push_frame(renderer);
            break;
        }
        case static_cast<int>(Page::SUBMIT): {
            submit::push_frame(renderer);
            break;
        }
        ...
        case static_cast<int>(Page::VIEW_GRADING): {
            view_grading::push_frame(renderer);
            break;
        }
        case static_cast<int>(Page::SUMMARY): {
            summary::push_frame(renderer);
            break;
        }
        default: {
